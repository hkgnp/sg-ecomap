...
function getPropsAndEvents(props) {
  ...
  Object.entries(rest).forEach(function (_a) {
    ...
    if (propName.startsWith("on")) {
      clusterEvents = __assign(
        __assign({}, clusterEvents),
        ((_b = {}), (_b[propName] = prop), _b),
      );
    } else {
      clusterProps = __assign(
        __assign({}, clusterProps),
        ((_c = {}), (_c[propName] = prop), _c),
      );
    }
  });
...
function createMarkerClusterGroup(props, context) {
  var _a = getPropsAndEvents(props),
    clusterProps = _a.clusterProps,
    clusterEvents = _a.clusterEvents;
  var markerClusterGroup = new leaflet_1.default.MarkerClusterGroup(
    clusterProps,
  );
  ...
  return (0, core_1.createElementObject)(
    markerClusterGroup,
    (0, core_1.extendContext)(context, { layerContainer: markerClusterGroup }),
  );
}
...
var MarkerClusterGroup = (0, core_1.createPathComponent)(
